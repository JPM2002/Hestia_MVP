...
_PHRASES: dict[str, dict[Lang, str]] = {
    ...
    "reception_fallback": {
        "es": (
            "Para resolver esta duda te pedimos escriba a recepción al *+56 9 7796 7879* "
            "Si necesitas que gestionemos algo (ej. pedir algo a la habitación), "
            "dime 'Necesito...' y lo registramos. 😊"
        ),
        "en": (
            "To clarify this, please write to Reception at *+56 9 7796 7879*.\n\n"
            "If you need us to arrange something (e.g., bring something to your room), "
            "tell me “I need…” and I’ll log it. 😊"
        ),
        "pt": (
            "Para esclarecer esta dúvida, pedimos que escreva para a Recepção no *+56 9 7796 7879* "
